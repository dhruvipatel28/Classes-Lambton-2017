...
('3', 'def@gmail.com', 'def', '2014-01-01'); /* 12 Jna 2017 */
...
('3', '271, Yorkland Blvd', 'North York', '1', '6478907655', '758749586');

INSERT INTO tbl_customer
(customer_id, first_name, last_name, email_address, password, address_id, date_added, points, nwesletter)
VALUES
(1, 'Mick', 'Ross', 'abc.def@yahoo.com', 'abc', 1, '2016-08-16', 5, 0) ,
(2, 'Rachel', 'Zane', 'abc1@gmail.com', 'abc1', 2, '2017-09-12', 0, 1) ,
(3, 'Harvy', 'Spector', 'harvy.s@gmail.com', 'spect', 3, '2016-04-27', 0, 1) ;
...
('2', 'Htc Phones', 'HTC Phones', '3', '2015-03-15'),
...
( order_id ,  customer_id , product_id,  payment_firstname ,  payment_lastname ,
payment_address ,  payment_method ,  shipping_firstname ,  shipping_lastname , shipping_address ,
total ,  order_status ,  date_added ,  date_modified ) 
  
VALUES ('1', '1', '7', 'Mick', 'Ross',
 '1', 'VISA', 'Ross', 'Mick', '1',
 '99.99', '3', '2017-07-10', '2017-07-10');
...
CREATE PROCEDURE Add_points(Order_id int(10) )
BEGIN
